...
function buildPage({ title, intro, blocks }) {
  ...
  for (const block of blocks) {
    ...
    kids.push(shortcodeWidget(block.shortcode));
...
const PAGES = [
  ...
  },
  {
    ...
    blocks: [{ shortcode: sc('tests', 'service="men" height="900"') }],
  },
  {
    slug: 'coleebri-service-women',
    title: "Women's health tests",
    blocks: [{ shortcode: sc('tests', 'service="women" height="900"') }],
  },
  {
    slug: 'coleebri-service-general',
    title: 'General health tests',
    blocks: [{ shortcode: sc('tests', 'service="general" height="900"') }],
  },
  {
    slug: 'coleebri-service-sexual',
    title: 'Sexual health tests',
    blocks: [{ shortcode: sc('tests', 'service="sexual" height="880"') }],
  },
  {
    slug: 'coleebri-service-fitness',
    title: 'Fitness & allergies tests',
    blocks: [{ shortcode: sc('tests', 'service="fitness" height="900"') }],
  },
  {
    slug: 'coleebri-service-dna',
    title: 'DNA tests',
    blocks: [{ shortcode: sc('tests', 'service="dna" height="900"') }],
  },
  {
